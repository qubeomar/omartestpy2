...
from qube.src.api.omartestpy2controller import omartestpy2Controller
from qube.src.api.omartestpy2controller import omartestpy2ItemController
from qube.src.api.versioncontroller import omartestpy2ItemVersionController
...
api.add_resource(omartestpy2ItemVersionController, '/v1/omartestpy2/version')
api.add_resource(omartestpy2Controller, '/v1/omartestpy2')
api.add_resource(omartestpy2ItemController, '/v1/omartestpy2/<string:entity_id>')
