...
from qube.src.api.swagger_models.omartestpy2 import VersionModel
...
class omartestpy2ItemVersionController(Resource):
    def __init__(self, *args, **kwargs):
        super(omartestpy2ItemVersionController, self).__init__(*args, **kwargs)
        self.config = QubeConfig.get_config()

    @swagger.doc(
        {
            'tags': ['omartestpy2'],
            'description': 'omartestpy2 Version operation',
