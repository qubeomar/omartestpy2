...
HELLO_VERSION = "/v1/omartestpy2/version"
...
class Testomartestpy2VersionController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("setup")
    ...
    def test_omartestpy2_default_version(self, *args, **kwargs):
    ...
    def test_omartestpy2_git_version(self, *args, **kwargs):
        QubeConfig.get_config().QUBE_VERSION_FILE = resource_filename(
